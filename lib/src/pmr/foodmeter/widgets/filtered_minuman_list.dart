...
class FilteredMinumanList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return FilteredMinumanListState();
  }
}

class FilteredMinumanListState extends State<FilteredMinumanList> {
  ...
  Future<ModelData> sendPagesDataRequest(int page) async {
    print('page ${page}');
    try {
      String url = AppConstants.LIST_FOOD_URL + '2/1/0/0?page=$page';
      print("$url");
