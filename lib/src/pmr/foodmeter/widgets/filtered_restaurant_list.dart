...
class FilteredRestaurantList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return FilteredRestaurantListState();
  }
}

class FilteredRestaurantListState extends State<FilteredRestaurantList> {
  ...
  Future<ModelDataResto> sendPagesDataRequest(int page) async {
    print('page ${page}');
    try {
      String url = AppConstants.LIST_FOOD_URL + '3/1/0/0?page=$page';
      print('$url');
