...
class FilteredMakananList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return FilteredMakananListState();
  }
}

class FilteredMakananListState extends State<FilteredMakananList> {
  ...
  Future<ModelData> sendPagesDataRequest(int page) async {
    print('page ${page}');
    try {
      String url = AppConstants.LIST_FOOD_URL + '1/1/0/0?page=$page';
      print("$url");
