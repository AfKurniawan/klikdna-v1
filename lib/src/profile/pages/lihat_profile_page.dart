                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Jenis Kelamin"),
                          SizedBox(height: 10),
                          Text(prov.gender == null ? "-" : prov.gender, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          SizedBox(height: 20),
                          Text("Email"),
                          SizedBox(height: 10),
                          Text(prov.profilEmail == null ? "-" : prov.profilEmail, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          SizedBox(height: 20),
                          Text("No. Ponsel"),
                          SizedBox(height: 10),
                          Text(prov.phone == null ? "-" : prov.phone, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          SizedBox(height: 20),
                          Text("Alamat"),
                          SizedBox(height: 10),
                          Text(
                              prov.address == null ? "-"
                                  : prov.address, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                          SizedBox(height: 20),
                          Text("Alamat Web Replika"),
                          SizedBox(height: 10),
                          Text(prov.referralUrl == null ? "-" : prov.referralUrl, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                  ),
