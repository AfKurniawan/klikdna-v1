...
class JsonData {
  ...
  JsonData({this.wallets, this.referrals, this.referralsmap, this.mitramap});
  ...
  JsonData.fromJson(Map<String, dynamic> json) {
    ...
    referralsmap = json['referralsmap'] != null
        ...
        : null;
    mitramap = json['mitramap'] != null
        ? new Wallets.fromJson(json['mitramap'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.mitramap != null) {
      data['mitramap'] = this.mitramap.toJson();
    }
    return data;
  }
}
...
class Wallets {
  ...
  Wallets.fromJson(Map<String, dynamic> json) {
    ...
    url = json['url'];
    params =
    json['params'] != null ? new ParamWallet.fromJson(json['params']) : null;
  }
...
class ParamWallet {
  ...
  ParamWallet({this.accesskey, this.typeId, this.datefrom, this.dateto});

  ParamWallet.fromJson(Map<String, dynamic> json) {
    accesskey = json['accesskey'];
    typeId = json['type_id'];
