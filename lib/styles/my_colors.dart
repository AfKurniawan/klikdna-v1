...
class MyColors {
  ...
  static const Color fmBacgroudColor = Color(0xffE5E5E5);
  ...
  static const Color dnaBackground = Color(0xffE5E5E5);
  static const Color overlaySlider = Color(0xff103636);

  /// REPORT
  static const Color sportBlue = Color(0xff2663AB);
